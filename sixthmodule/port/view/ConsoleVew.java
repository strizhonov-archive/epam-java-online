...
public  class ConsoleVew {
    ...
    public synchronized void printConnection(Vessel vessel, Pier pier) {
        ...
        System.out.println("port.model.Vessel " + vessel.getName() + " arrived for pier #"
                + (pier.getPierNum() + 1));
        System.out.println("port.model.Vessel " + vessel.getName() +" has "
    ...
    public synchronized void printDeparture(Vessel vessel, Pier pier) {
        ...
        System.out.println("port.model.Vessel " + vessel.getName() + " departed from pier #"
                + (pier.getPierNum() + 1));
        System.out.println("port.model.Vessel " + vessel.getName() +" has "
                + vessel.getCargo() + " tons cargo; pier #" + (pier.getPierNum() + 1)
    ...
    public synchronized void printLoading(Vessel vessel, Pier pier, int loadAmount) {
        ...
        System.out.println("port.model.Vessel " + vessel.getName() + " gets "
    ...
    public synchronized void printUnloading(Vessel vessel, Pier pier, int loadAmount) {
        ...
        System.out.println("port.model.Vessel " + vessel.getName() + " drops "
    ...
    public synchronized void printInability(Vessel vessel, Pier pier) {
        ...
        System.out.println("Unable to implement cargo exchange: port.model.Vessel "
                + vessel.getName() + "; port.model.Pier #" + pier.getPierNum());
        System.out.println();
    }
